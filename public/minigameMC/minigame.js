function runMiniGame () {
    ...
    function preload() {
        //questions
        game.load.image('question1', 'minigameMC/assets/question1.png');
        game.load.image('question3', 'minigameMC/assets/question3.png');
        game.load.image('question2', 'minigameMC/assets/question2.png');
        
        //question 1 choices
        game.load.image('q1c', 'minigameMC/assets/q1c.png');
        game.load.image('q1i1', 'minigameMC/assets/q1i1.png');
        game.load.image('q1i2', 'minigameMC/assets/q1i2.png');
        game.load.image('q1i3', 'minigameMC/assets/q1i3.png');
        
        //question 2 choices
        game.load.image('q2c', 'minigameMC/assets/q2c.png');
        game.load.image('q2i1', 'minigameMC/assets/q2i1.png');
        game.load.image('q2i2', 'minigameMC/assets/q2i2.png');
        game.load.image('q2i3', 'minigameMC/assets/q2i3.png');
        
        //question 3 choices
        game.load.image('q3c', 'minigameMC/assets/q3c.png');
        game.load.image('q3i1', 'minigameMC/assets/q3i1.png');
        game.load.image('q3i2', 'minigameMC/assets/q3i2.png');
        game.load.image('q3i3', 'minigameMC/assets/q3i3.png');
    ...
    function create() {
        ...
        //add first question and choices
    ...
    //calculates the reward based on base amount times number of questions correct
    function rewardCounter(){
        return 50 * score;
    }
    
    //loads the next question based on the current question number

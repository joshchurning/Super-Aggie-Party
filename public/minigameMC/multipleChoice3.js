function runMiniGame3 () {
    ...
    function preload() {
        //questions
        game.load.image('question1', 'minigameMC/assets/m3q1q.png');
        game.load.image('question3', 'minigameMC/assets/m3q3q.png');
        game.load.image('question2', 'minigameMC/assets/m3q2q.png');
        
        //question 1 choices
        game.load.image('q1c', 'minigameMC/assets/m3q1c.png');
        game.load.image('q1i1', 'minigameMC/assets/m3q1i1.png');
        game.load.image('q1i2', 'minigameMC/assets/m3q1i2.png');
        game.load.image('q1i3', 'minigameMC/assets/m3q1i3.png');
        
        //question 2 choices
        game.load.image('q2c', 'minigameMC/assets/m3q2c.png');
        game.load.image('q2i1', 'minigameMC/assets/m3q2i1.png');
        game.load.image('q2i2', 'minigameMC/assets/m3q2i2.png');
        game.load.image('q2i3', 'minigameMC/assets/m3q2i3.png');
        
        //question 3 choices
        game.load.image('q3c', 'minigameMC/assets/m3q3c.png');
        game.load.image('q3i1', 'minigameMC/assets/m3q3i1.png');
        game.load.image('q3i2', 'minigameMC/assets/m3q3i2.png');
        game.load.image('q3i3', 'minigameMC/assets/m3q3i3.png');
